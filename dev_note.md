...
> 開發參考用。網站前台渲染的是 `README.md`，不會顯示本檔——
> 但**這個 repo 是公開的**，寫在這裡的東西任何人都看得到，別放不能公開的內容。
...
### 近期
- [ ] `daikan.html` 人稱統一：通篇是「**我們**幫你跑完 / **我們**用一次性授權憑證」，
      但結尾變成「私訊，**我**會說明細節」。前面建立的服務形象最後一句掉回單人。
      要嘛全篇改「我」（小工作室感、誠實），要嘛結尾改「我們」。
      *（2026-09-02 檢出，暫不處理——目前沒有實際客戶）*
